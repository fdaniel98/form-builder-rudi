...
class FieldConstructor extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { style: { display: 'flex', justifyContent: 'flex-start', alignContent: 'center', alignItems: 'center', height: '100%', width: '85%', border: 'solid 1px rbga(255,255,255, .6)', borderRadius: '10px' } },
                ...
                React.createElement(core_1.Paper, { style: { width: '100%', height: '100%' }, elevation: 1 },
                    React.createElement(core_1.Grid, { container: true, justify: "center", alignContent: "center", alignItems: "center" },
                        React.createElement(core_1.Grid, { item: true, xs: 12, style: { padding: '20px' } },
                            React.createElement(core_1.Grid, { container: true },
                                ...
                                isSoftExpertForm && (React.createElement(core_1.Grid, { item: true, xs: 12 },
                                    React.createElement(core_1.Typography, { variant: "h5", component: "h5", style: { color: '#0d38b1', display: 'flex', justifyContent: 'center' } }, "Formulario proveniente de SoftExpert"))))),
                        React.createElement(core_1.Grid, { item: true, xs: 12 },
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 12, style: { paddingTop: '10px', paddingLeft: '5px' } },
                            React.createElement(core_1.Grid, { container: true },
                                pagesFields.map((_value, index) => (React.createElement(core_1.Zoom, { in: true },
                                    React.createElement(core_1.Grid, { className: "btn", item: true, xs: 3, style: { display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center' } },
                                        React.createElement(core_1.Card, { elevation: 0, style: { borderRadius: '5px', width: '40%' }, onClick: (e) => handlePageSelected(e, index) },
                                            React.createElement(core_1.Typography, { variant: "caption", component: "span", style: { display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center', color: '#0d38b1' } }, (onPage === index) ? (React.createElement("strong", null, `Pagina - ${index + 1}`))
                                                :
                                                    (React.createElement("p", null, `Pagina - ${index + 1}`)))),
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 12, style: { paddingTop: '5px' } },
                            React.createElement(core_1.Divider, null)),
                        React.createElement(core_1.Grid, { item: true, xs: 12, style: { padding: '20px', justifyContent: 'center', alignItems: 'center', alignContent: 'center' } }, isLoadingFields ? (React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', alignContent: 'center' } },
                            React.createElement(core_1.CircularProgress, { color: "primary" })))
                            :
                                (fields.length > 0 ? (React.createElement(react_beautiful_dnd_1.Droppable, { droppableId: "droppable-1" }, (provided) => (React.createElement(core_1.Grid, Object.assign({ innerRef: provided.innerRef }, provided.droppableProps, { container: true, justify: "flex-start", alignContent: "center", alignItems: "center" }),
                                    ...
                                    :
                                        (React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', alignContent: 'center' } },
