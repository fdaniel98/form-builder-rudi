...
class FieldSelector extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { style: {
            ...
            React.createElement("div", { style: { paddingLeft: "10px", width: "90%" } }, isLoading ? (React.createElement(core_1.CircularProgress, { color: "primary" })) : (React.createElement(core_1.Button, { className: "btn", variant: "contained", style: { backgroundColor: "#0d38b1", color: "white" }, fullWidth: true, onClick: this.handleSave, disabled: true }, "Guardar formulario")))));
    }
}
