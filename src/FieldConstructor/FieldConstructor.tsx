...
import { Grid, Paper, Typography, Divider, Select, OutlinedInput, MenuItem, FormControl, InputLabel, Card, CardContent, TextField, CircularProgress, Zoom } from '@material-ui/core';
...
export default class FieldConstructor extends React.Component<FieldConstructorProps> {
    ...
    render() {
        ...
        const {
            fields,
            pagesFields,
            handleDeleteField, handleSaveField,
            addFieldGrid, isSoftExpertForm,
            institutions, services,
            handleService, handleInstitution,
        ...
        return (
            <div style={{ display: 'flex', justifyContent: 'flex-start', alignContent: 'center', alignItems: 'center', height: '100%', width: '85%', border: 'solid 1px rbga(255,255,255, .6)', borderRadius: '10px' }}>
                    ...
                    <Paper style={{ width: '100%', height: '100%' }} elevation={1}>
                        <Grid container justify="center" alignContent="center" alignItems="center">
                            <Grid item xs={12} style={{ padding: '20px' }}>
                                <Grid container>
                                    <Grid item xs={12}>
                                        <Typography variant="h5" component="h5" style={{ display: 'flex', justifyContent: 'center' }}>
                                    ...
                                    </Grid>
                                    {
                                        isSoftExpertForm && (
                                            <Grid item xs={12}>
                                                <Typography variant="h5" component="h5" style={{ color: '#0d38b1', display: 'flex', justifyContent: 'center' }}>
                                                    Formulario proveniente de SoftExpert
                                                </Typography>
                                            </Grid>
                                        )
                                    }
                                        ...
                                        <div style={{ width: '90%' }}>
                                            <FormControl variant="outlined" fullWidth>
                                                ...
                                                <Select fullWidth
                                                    ...
                                                    input={<OutlinedInput fullWidth labelWidth={12} name="institution" id="institutionSelect" />}>
                                                    <MenuItem key={'disabled-institution-item'} value="" disabled>
                                        ...
                                        <div style={{ width: '90%' }}>
                                            <FormControl variant="outlined" fullWidth>
                                                ...
                                                <Select fullWidth
                                                    ...
                                                    input={<OutlinedInput fullWidth labelWidth={12} name="service" id="serviceSelect" />}>
                                                    <MenuItem key={'disabled-service-item'} value="" disabled>
                            ...
                            <Grid item xs={12} style={{ paddingTop: '10px', paddingLeft: '5px' }}>
                                <Grid container>
                                    {
                                        pagesFields.map((_value: any, index: number) => (
                                            <Zoom in={true}>
                                                <Grid className="btn" item xs={3} style={{ display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center' }}>
                                                    <Card elevation={0} style={{ borderRadius: '5px', width: '40%' }} onClick={(e) => handlePageSelected(e, index)}>
                                                        <Typography variant="caption" component="span" style={{ display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center', color: '#0d38b1' }}>
                                                            {
                                                                (onPage === index) ? (
                                                                    <strong>
                                                                        {
                                                    ...
                                                    </Card>
                                                    {
                                                        (index !== 0) && (
                                                            <span className="btn">
                                                                <Delete style={{ color: '#ea1212', width: 15 }} onClick={(e) => handleDeletePageField(e, index)} />
                                                            </span>
                                                        )
                                                    }
                                                </Grid>
                                    ...
                                    <Grid className="btn" item xs={3}>
                                        <Card elevation={0} onClick={handleAddPageField} style={{ borderRadius: '5px', width: '40%' }}>
                            ...
                            <Grid item xs={12} style={{ padding: '20px', justifyContent: 'center', alignItems: 'center', alignContent: 'center' }}>
                                {
                                    isLoadingFields ? (
                            ...
                            <Grid item xs={12}>
                                <FieldSelectorAcumulation fields={fields}
                            ...
                            <Grid item xs={12}>
                                <FieldModal content={
                                    <FieldEditForm field={fields[positionOnEdit]}
